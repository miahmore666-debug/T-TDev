...
// Validate ../../app/api/compounds/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/compounds">> = Specific
  const handler = {} as typeof import("../../app/api/compounds/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
